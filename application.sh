...
then
	...
	ps aux | grep 2.21
	sleep 5	
	echo "${green}Selenium OK${endColor}"
	echo "${green}Application Test READY${endColor}"
else
	echo "${red}Application Test NOT READY${endColor}"
fi
